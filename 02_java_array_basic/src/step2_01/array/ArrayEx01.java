...
public class ArrayEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr[0]);	// 배열은 초깃값이 자동으로 생성이 되며 
		System.out.println(arr[1]);	// 정수형태의 초깃값은 0 이다. 나머지는 직접 확인해보세요.
		...
		//java.lang.ArrayIndexOutOfBoundsException: 5 > 해당 에러메세지 암기
